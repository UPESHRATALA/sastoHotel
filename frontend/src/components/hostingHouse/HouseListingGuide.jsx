...
const HouseListingGuide = () => {
  return (
    <section className=" my-8 md:my-20 flex flex-col gap-10">
      ...
      SastoHotel it easily with SastoHotel Setup
      </h1>
      <>
      ...
      <div className=" grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <SetupCard
          ...
          subHeading={
            "For your first booking, you can choose to welcome an experienced guest who has at least three stays and a good track record on SastoHotel."
          }
        />
        <SetupCard
          heading={"Specialized support from SastoHotel"}
          subHeading={
