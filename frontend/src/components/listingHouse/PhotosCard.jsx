  ...
  useEffect(() => {
    async function uploadImagetoCloudinary() {
      if (inputImage !== null && inputImage?.size / 500000 < 5) {
        ...
        imageFormData.append("upload_preset", "sastohotel1");
        imageFormData.append("cloud_name", "dkoirxcqm");
        imageFormData.append("api_key", "884966512418569");

        // saving to cloudinary
        setIsImgUploading(true);
        try {
          await fetch(
            "https://api.cloudinary.com/v1_1/dkoirxcqm/image/upload",
            {
              method: "POST",
              body: imageFormData,
            }
